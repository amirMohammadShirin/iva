...
@NonNullApi
public class IvaProjectDependency extends DelegatingProjectDependency {

    @Inject
    public IvaProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
    ...
    /**
     * Creates a project dependency on the project at path ":uiKit"
     */
    public UiKitProjectDependency getUiKit() { return new UiKitProjectDependency(getFactory(), create(":uiKit")); }

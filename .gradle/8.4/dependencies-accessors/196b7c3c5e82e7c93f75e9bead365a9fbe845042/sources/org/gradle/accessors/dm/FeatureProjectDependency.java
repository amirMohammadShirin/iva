...
public class FeatureProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":feature:intro"
     */
    public Feature_IntroProjectDependency getIntro() { return new Feature_IntroProjectDependency(getFactory(), create(":feature:intro")); }
